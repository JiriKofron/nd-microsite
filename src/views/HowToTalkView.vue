...
const fetchData = async () => {
  ...
  kartyMistaStrachu.value = await parseKartyMistaStrachu(podpurnyRozhovorAcf.value?.karty_mista_strachu)
...
<section class="w-full">
  ...
  <section class="flex flex-col items-center p-8 gap-8 mb-16">
    ...
    <div class="flex flex-col gap-8">
      <DownloadCard v-for="soubor in kartyKeStazeni" :key="soubor.nazev_souboru" :download-link="soubor.soubor">
  ...
  >
    ...
    <p class="text-base font-roboto font-bold text-orange m-0">
      Bojíme se například
    </p>

    <ul class="m-0 pl-8">
      <li v-for="obava in kartyMistaStrachu.obavy" :key="obava.obava" class="py-2 flex items-center list-none gap-3">

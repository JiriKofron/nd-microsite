...
>
  <section class="flex flex-col items-center justify-center max-w-[900px] p-8 md:mx-auto">
    <article class="flex items-center justify-center w-100 p-4 gap-x-8">
      ...
      />
      <p
          class="text-17 leading-8 font-medium text-primary-text font-roboto md:text-heading md:text-orange md:font-baloo md:font-semibold"
      >
        {{acf.popis}}
      </p>
    </article>
    ...
    >
      ...
      <div class="flex flex-col items-center justify-center gap-y-16 p-4">
        ...
        <article class="bg-yellow p-8 pb-16 rounded-2xl md:w-[95%] md:mx-32">
          <div class="flex items-start gap-8 mb-6">
          ...
          >
            ...
            <div class="flex flex-col md:flex-row items-center md:items-stretch justify-center gap-x-12">

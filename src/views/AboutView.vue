...
const parseSpolupracujiciOrganizace = async (spolupracujiciOrganizace: SpolupracujiciOrganizace[] | undefined) => {
...
onMounted(async () => {
  ...
  spolupracujiciOrganizace.value = await parseSpolupracujiciOrganizace(oProjektuAcf.value?.spolupracujici_organizace)
})
  ...
  <section v-if="oProjektuAcf" class="max-w-[900px]">
    <article class="flex flex-col items-center justify-center bg-salmon px-8 py-10 md:p-16 gap-y-8 md:gap-y-16">
      <div class="flex justify-start md:justify-center gap-x-8 px-4">
        ...
        />
        <h1
            class="font-baloo text-25 md:text-30 text-primary font-semibold m-0"
        >{{oProjektuAcf.o_projektu.nadpis}}</h1>
      </div>
      ...
      <div>
        <ul class="flex flex-col gap-12 md:gap-6 pl-0 md:pl-6">
          ...
          >
            ...
            <span>
              <span
                  class="text-base font-roboto font-bold text-primary"
              >
                {{`${autor.jmeno} - ` }}
              </span>
              <span class="text-base font-roboto font-normal tracking-[0.01em] text-primary-text">{{autor.pozice}}</span>
            </span>
          </li>
        </ul>
      </div>
    ...
    >
      <div class="flex flex-col items-center">
        <h3
            class="text-22 md:text-heading font-baloo font-semibold text-primary m-0"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          <div class="flex items-stretch justify-between px-8 py-2 bg-yellow w-full rounded-10 overflow-hidden ">
            ...
            <div class="flex">
              ...
              <a :href="organizace.odkaz" target="_blank" class="flex items-center justify-center pl-8">
                <img src="@/assets/icons/ico-open-in-new.svg" alt="ikona pro otevření odkazu v novém okně" />
              </a>
            </div>
          </div>
        </div>

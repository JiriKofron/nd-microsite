...
<template>
  <section v-if="oProjektuAcf" class="max-w-[900px]">
    ...
    <section class="flex flex-col p-8">
      <h2 class="text-heading lg:text-heading-large font-baloo font-bold text-primary text-center">
        Autorský tým
      </h2>
        ...
        <ul class="flex flex-col gap-12 md:gap-6 pl-0 md:pl-6">
          ...
          >
            ...
            <span>
              ...
              <span class="text-base font-roboto font-normal tracking-[0.01em] text-primary-text">{{
                autor.pozice
              }}</span>
            </span>
          </li>
    ...
    <section v-if="spolupracujiciOrganizace" class="flex flex-col items-center gap-8 p-8 md:py-16">
